...
function BoxFormModal({ initial, onSave, onClose, onDelete, nextBatchFor, prefillBoxNumber, allBoxes, settings, onPrintSticker }) {
  ...
  return /* @__PURE__ */ React.createElement(Modal, { title: isNew ? "\u0E40\u0E1E\u0E34\u0E48\u0E21\u0E01\u0E25\u0E48\u0E2D\u0E07\u0E1B\u0E39\u0E43\u0E2B\u0E21\u0E48" : restock ? `\u0E25\u0E07\u0E1B\u0E39\u0E43\u0E2B\u0E21\u0E48 \u2014 \u0E01\u0E25\u0E48\u0E2D\u0E07 #${f.boxNumber}` : `\u0E01\u0E25\u0E48\u0E2D\u0E07 #${f.boxNumber} \xB7 \u0E23\u0E38\u0E48\u0E19\u0E17\u0E35\u0E48 ${f.batchNumber}`, onClose, wide: true }, /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "minmax(0, 1fr) minmax(0, 1fr)", gap: "0 16px" } }, /* @__PURE__ */ React.createElement(Field, { label: "\u0E40\u0E1A\u0E2D\u0E23\u0E4C\u0E01\u0E25\u0E48\u0E2D\u0E07", hint: "\u0E23\u0E39\u0E1B\u0E41\u0E1A\u0E1A: \u0E15\u0E31\u0E27\u0E2D\u0E31\u0E01\u0E29\u0E23\u0E41\u0E16\u0E27 + \u0E40\u0E25\u0E02\u0E0A\u0E48\u0E2D\u0E07 \u0E40\u0E0A\u0E48\u0E19 A01, B03" }, /* @__PURE__ */ React.createElement("input", { style: { ...inputStyle, ...(boxNumberError ? { border: `1.5px solid ${C.coral}` } : {}) }, value: f.boxNumber, disabled: !isNew, onChange: (e) => { set("boxNumber", e.target.value.toUpperCase().replace(/[^A-Z0-9]/g, "")); setBoxNumberError(""); }, placeholder: "\u0E40\u0E0A\u0E48\u0E19 A01" }), boxNumberError && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11.5, color: C.coral, marginTop: 4, fontWeight: 600 } }, boxNumberError)), /* @__PURE__ */ React.createElement(Field, { label: "\u0E40\u0E1E\u0E28" }, /* @__PURE__ */ React.createElement("select", { style: inputStyle, value: f.sex, onChange: (e) => set("sex", e.target.value) }, /* @__PURE__ */ React.createElement("option", { value: "male" }, "\u0E15\u0E31\u0E27\u0E1C\u0E39\u0E49"), /* @__PURE__ */ React.createElement("option", { value: "female" }, "\u0E15\u0E31\u0E27\u0E40\u0E21\u0E35\u0E22"))), /* @__PURE__ */ React.createElement("div", { style: { gridColumn: "1 / -1" } }, /* @__PURE__ */ React.createElement(Field, { label: "\u0E27\u0E31\u0E19\u0E25\u0E07\u0E1B\u0E39" }, /* @__PURE__ */ React.createElement("input", { type: "date", style: { ...inputStyle, maxWidth: 220 }, value: f.stockDate || "", onChange: (e) => set("stockDate", e.target.value) }))), /* @__PURE__ */ React.createElement(Field, { label: "\u0E19\u0E49\u0E33\u0E2B\u0E19\u0E31\u0E01\u0E1B\u0E31\u0E08\u0E08\u0E38\u0E1A\u0E31\u0E19 (\u0E01\u0E23\u0E31\u0E21)" }, /* @__PURE__ */ React.createElement("input", { type: "number", style: inputStyle, value: f.currentWeight, onChange: (e) => set("currentWeight", e.target.value) })), /* @__PURE__ */ React.createElement(Field, { label: "\u0E19\u0E49\u0E33\u0E2B\u0E19\u0E31\u0E01\u0E40\u0E1B\u0E49\u0E32\u0E2B\u0E21\u0E32\u0E22 (\u0E01\u0E23\u0E31\u0E21)" }, /* @__PURE__ */ React.createElement("input", { type: "number", style: inputStyle, value: f.targetWeight, onChange: (e) => set("targetWeight", e.target.value) })), /* @__PURE__ */ React.createElement(Field, { label: "\u0E40\u0E1B\u0E49\u0E32\u0E2B\u0E21\u0E32\u0E22\u0E01\u0E25\u0E48\u0E2D\u0E07\u0E19\u0E35\u0E49" }, /* @__PURE__ */ React.createElement("select", { style: inputStyle, value: f.goal || "", onChange: (e) => set("goal", e.target.value) }, /* @__PURE__ */ React.createElement("option", { value: "" }, "\u0E44\u0E21\u0E48\u0E23\u0E30\u0E1A\u0E38"), /* @__PURE__ */ React.createElement("option", { value: "fatten" }, "\u0E02\u0E38\u0E19\u0E43\u0E2B\u0E49\u0E42\u0E15"), /* @__PURE__ */ React.createElement("option", { value: "eggs" }, "\u0E23\u0E2D\u0E44\u0E02\u0E48"), /* @__PURE__ */ React.createElement("option", { value: "molt" }, "\u0E23\u0E2D\u0E25\u0E2D\u0E01\u0E04\u0E23\u0E32\u0E1A"), /* @__PURE__ */ React.createElement("option", { value: "quick_sale" }, "\u0E02\u0E32\u0E22\u0E14\u0E48\u0E27\u0E19"), /* @__PURE__ */ React.createElement("option", { value: "broodstock" }, "\u0E1E\u0E48\u0E2D\u0E1E\u0E31\u0E19\u0E18\u0E38\u0E4C"))), f.sex === "female" && /* @__PURE__ */ React.createElement(Field, { label: "\u0E44\u0E02\u0E48 (%)" }, /* @__PURE__ */ React.createElement("input", { type: "number", min: "0", max: "100", style: inputStyle, value: f.eggPercent, onChange: (e) => set("eggPercent", e.target.value) })), /* @__PURE__ */ React.createElement(Field, { label: "\u0E1B\u0E23\u0E34\u0E21\u0E32\u0E13\u0E2D\u0E32\u0E2B\u0E32\u0E23/\u0E27\u0E31\u0E19 (\u0E01\u0E23\u0E31\u0E21)" }, /* @__PURE__ */ React.createElement("input", { type: "number", style: inputStyle, value: f.feedPerDay, onChange: (e) => set("feedPerDay", e.target.value) })), /* @__PURE__ */ React.createElement(Field, { label: "\u0E15\u0E49\u0E19\u0E17\u0E38\u0E19\u0E17\u0E35\u0E48\u0E23\u0E31\u0E1A\u0E21\u0E32 (\u0E1A\u0E32\u0E17/\u0E15\u0E31\u0E27)" }, /* @__PURE__ */ React.createElement("input", { type: "number", style: inputStyle, value: f.costPerCrab, onChange: (e) => set("costPerCrab", e.target.value) }))), !restock && !isNew && /* @__PURE__ */ React.createElement(MoltHistorySection, { f, settings, onAddMolt: addMoltEntry }), /* @__PURE__ */ React.createElement(Field, { label: "\u0E2B\u0E21\u0E32\u0E22\u0E40\u0E2B\u0E15\u0E38" }, /* @__PURE__ */ React.createElement("textarea", { style: { ...inputStyle, minHeight: 60, resize: "vertical" }, value: f.notes, onChange: (e) => set("notes", e.target.value) })), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", marginTop: 18 } }, /* @__PURE__ */ React.createElement("div", null, !isNew && onDelete && /* @__PURE__ */ React.createElement(Btn, { tone: "danger", onClick: async () => {
...
function App() {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { id: "crabfarm-app-shell", style: { fontFamily: BODY, background: C.paper, minHeight: "100vh", color: C.text, display: "flex" } }, /* @__PURE__ */ React.createElement("link", { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Space+Grotesk:wght@500;700&family=IBM+Plex+Sans:wght@400;500;600;700&family=IBM+Plex+Mono:wght@400;600;700&display=swap" }), /* @__PURE__ */ React.createElement("style", null, `
      ...
      `), /* @__PURE__ */ React.createElement("button", { onClick: () => setSidebarCollapsed((v) => !v), title: sidebarCollapsed ? "\u0E41\u0E2A\u0E14\u0E07\u0E41\u0E16\u0E1A\u0E40\u0E21\u0E19\u0E39" : "\u0E0B\u0E48\u0E2D\u0E19\u0E41\u0E16\u0E1A\u0E40\u0E21\u0E19\u0E39", style: { position: "fixed", top: 16, left: sidebarCollapsed ? 16 : 224, zIndex: 40, background: C.ink, color: "#fff", border: "none", borderRadius: 8, width: 36, height: 36, display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", fontSize: 16, boxShadow: "0 4px 12px rgba(0,0,0,0.25)", transition: "left 0.15s ease" } }, "\u2630"), !sidebarCollapsed && /* @__PURE__ */ React.createElement("div", { style: { width: 210, background: C.ink, color: "#fff", flexShrink: 0, padding: "22px 14px", display: "flex", flexDirection: "column", minHeight: "100vh" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 10, marginBottom: 26 } }, /* @__PURE__ */ React.createElement(LogoMark, { size: 48 }), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { fontFamily: DISPLAY, fontWeight: 700, fontSize: 16.5, letterSpacing: 0.2, lineHeight: 1.2 } }, "\u0E2D\u0E31\u0E19\u0E14\u0E32\u0E21\u0E31\u0E19\u0E1F\u0E32\u0E23\u0E4C\u0E21"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10.5, color: "rgba(255,255,255,0.55)" } }, "\u0E1F\u0E32\u0E23\u0E4C\u0E21\u0E1B\u0E39\u0E14\u0E33\u0E04\u0E2D\u0E19\u0E42\u0E14 \xB7 \u0E19\u0E49\u0E33\u0E17\u0E30\u0E40\u0E25\u0E40\u0E17\u0E35\u0E22\u0E21"))), TABS.map((t) => /* @__PURE__ */ React.createElement(
    "button",
    {
      key: t.id,
      onClick: () => setTab(t.id),
