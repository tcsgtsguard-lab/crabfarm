...
async function storageSetRaw(key, value) {
  try {
    ...
    if (!res) {
      console.error("storage set returned null", key);
      return false;
    }
    return true;
  } catch (e) {
