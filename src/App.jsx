...
const DEFAULT_SETTINGS = {
  ...
  feedCostPerKg: 35,
  currentSellPricePerKg: 500,
  targetSellPricePerKg: 600,
...
function computeBoxEconomics(box, settings, daysSinceStock) {
  const feedCostPerKg = Number(settings.feedCostPerKg) || 0;
  const currentSellPricePerKg = Number(settings.currentSellPricePerKg) || 0;
  const targetSellPricePerKg = Number(settings.targetSellPricePerKg) || 0;
  const feedPerDay = Number(box.feedPerDay) || 0;
  const days = daysSinceStock != null ? daysSinceStock : 0;
  const feedCost = feedPerDay / 1000 * days * feedCostPerKg;
  const initialCost = Number(box.costPerCrab) || 0;
  const totalCost = initialCost + feedCost;
  const currentWeight = Number(box.currentWeight) || 0;
  const targetWeight = Number(box.targetWeight) || 0;
  const currentValue = currentWeight / 1000 * currentSellPricePerKg;
  const targetValue = targetWeight / 1000 * targetSellPricePerKg;
  const currentProfit = currentValue - totalCost;
  const targetProfit = targetValue - totalCost;
  return { feedCost, initialCost, totalCost, currentValue, targetValue, currentProfit, targetProfit, hasTarget: targetWeight > 0 };
}
...
function BoxCard({ box, onOpen, onQuickHarvest, moltReminderDays, settings }) {
  const { isEmpty, lastMolt, daysSinceMolt, daysSinceStock, eggReady, weightReady, moltDue } = computeBoxStatus(box, moltReminderDays);
  const econ = !isEmpty && settings ? computeBoxEconomics(box, settings, daysSinceStock) : null;
  return /* @__PURE__ */ React.createElement(
    "div",
    {
      onClick: () => onOpen(box),
...
function BoxFormModal({ initial, onSave, onClose, onDelete, nextBatchFor, prefillBoxNumber, allBoxes, settings, onPrintSticker }) {
  ...
  const daysSinceStockForm = f.stockDate ? daysBetween(f.stockDate, todayStr()) : null;
  const econ = computeBoxEconomics(f, settings, daysSinceStockForm);
  const econSection = !isNew && !restock ? /* @__PURE__ */ React.createElement("div", { style: { background: "#F6F8F5", border: `1px solid ${C.line}`, borderRadius: 8, padding: 12, marginBottom: 14 } },
    /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, fontWeight: 700, color: C.brine, marginBottom: 8 } }, "\u0E15\u0E49\u0E19\u0E17\u0E38\u0E19 & \u0E01\u0E33\u0E44\u0E23"),
    /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12.5, color: C.text, lineHeight: 2 } },
      /* @__PURE__ */ React.createElement("div", null, "\u0E15\u0E49\u0E19\u0E17\u0E38\u0E19\u0E1B\u0E39\u0E17\u0E35\u0E48\u0E23\u0E31\u0E1A\u0E21\u0E32: ", /* @__PURE__ */ React.createElement("b", { style: { fontFamily: MONO } }, money(econ.initialCost), " \u0E1A\u0E32\u0E17")),
      /* @__PURE__ */ React.createElement("div", null, "\u0E15\u0E49\u0E19\u0E17\u0E38\u0E19\u0E2B\u0E31\u0E27\u0E2D\u0E32\u0E2B\u0E32\u0E23\u0E2A\u0E30\u0E2A\u0E21 (", daysSinceStockForm != null ? daysSinceStockForm : 0, " \u0E27\u0E31\u0E19): ", /* @__PURE__ */ React.createElement("b", { style: { fontFamily: MONO } }, money(econ.feedCost), " \u0E1A\u0E32\u0E17")),
      /* @__PURE__ */ React.createElement("div", null, "\u0E15\u0E49\u0E19\u0E17\u0E38\u0E19\u0E23\u0E27\u0E21: ", /* @__PURE__ */ React.createElement("b", { style: { fontFamily: MONO } }, money(econ.totalCost), " \u0E1A\u0E32\u0E17")),
      /* @__PURE__ */ React.createElement("div", { style: { marginTop: 4, paddingTop: 6, borderTop: `1px dashed ${C.line}` } }, "\u0E21\u0E39\u0E25\u0E04\u0E48\u0E32\u0E1B\u0E31\u0E08\u0E08\u0E38\u0E1A\u0E31\u0E19 (", money(settings.currentSellPricePerKg), " \u0E1A./\u0E01\u0E01.): ", /* @__PURE__ */ React.createElement("b", { style: { fontFamily: MONO } }, money(econ.currentValue), " \u0E1A\u0E32\u0E17")),
      /* @__PURE__ */ React.createElement("div", null, "\u0E01\u0E33\u0E44\u0E23\u0E15\u0E32\u0E21\u0E19\u0E49\u0E33\u0E2B\u0E19\u0E31\u0E01\u0E1B\u0E31\u0E08\u0E08\u0E38\u0E1A\u0E31\u0E19: ", /* @__PURE__ */ React.createElement("b", { style: { fontFamily: MONO, color: econ.currentProfit >= 0 ? C.seagrass : C.coral } }, money(econ.currentProfit), " \u0E1A\u0E32\u0E17")),
      econ.hasTarget && /* @__PURE__ */ React.createElement(React.Fragment, null,
        /* @__PURE__ */ React.createElement("div", { style: { marginTop: 4, paddingTop: 6, borderTop: `1px dashed ${C.line}` } }, "\u0E21\u0E39\u0E25\u0E04\u0E48\u0E32\u0E17\u0E35\u0E48\u0E19\u0E49\u0E33\u0E2B\u0E19\u0E31\u0E01\u0E40\u0E1B\u0E49\u0E32\u0E2B\u0E21\u0E32\u0E22 (", money(settings.targetSellPricePerKg), " \u0E1A./\u0E01\u0E01.): ", /* @__PURE__ */ React.createElement("b", { style: { fontFamily: MONO } }, money(econ.targetValue), " \u0E1A\u0E32\u0E17")),
        /* @__PURE__ */ React.createElement("div", null, "\u0E01\u0E33\u0E44\u0E23\u0E04\u0E32\u0E14\u0E01\u0E32\u0E23\u0E13\u0E4C (\u0E17\u0E35\u0E48\u0E40\u0E1B\u0E49\u0E32\u0E2B\u0E21\u0E32\u0E22): ", /* @__PURE__ */ React.createElement("b", { style: { fontFamily: MONO, color: econ.targetProfit >= 0 ? C.seagrass : C.coral } }, money(econ.targetProfit), " \u0E1A\u0E32\u0E17"))
      )
    ),
    /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10.5, color: C.muted, marginTop: 6 } }, "\u0E23\u0E32\u0E04\u0E32\u0E2D\u0E49\u0E32\u0E07\u0E2D\u0E34\u0E07\u0E15\u0E31\u0E49\u0E07\u0E2B\u0E19\u0E49\u0E32\u0E15\u0E31\u0E49\u0E07\u0E04\u0E48\u0E32 \u2014 \u0E41\u0E01\u0E49\u0E44\u0E14\u0E49\u0E17\u0E35\u0E48\u0E40\u0E21\u0E19\u0E39 \u0E15\u0E31\u0E49\u0E07\u0E04\u0E48\u0E32")
  ) : null;
  return /* @__PURE__ */ React.createElement(Modal, { title: isNew ? "\u0E40\u0E1E\u0E34\u0E48\u0E21\u0E01\u0E25\u0E48\u0E2D\u0E07\u0E1B\u0E39\u0E43\u0E2B\u0E21\u0E48" : restock ? `\u0E25\u0E07\u0E1B\u0E39\u0E43\u0E2B\u0E21\u0E48 \u2014 \u0E01\u0E25\u0E48\u0E2D\u0E07 #${f.boxNumber}` : `\u0E01\u0E25\u0E48\u0E2D\u0E07 #${f.boxNumber} \xB7 \u0E23\u0E38\u0E48\u0E19\u0E17\u0E35\u0E48 ${f.batchNumber}`, onClose, wide: true }, /* @__PURE__ */ React.createElement("div", { className: "cf-grid-2col", style: { display: "grid", gridTemplateColumns: "minmax(0, 1fr) minmax(0, 1fr)", gap: "0 16px" } }, /* @__PURE__ */ React.createElement(Field, { label: "\u0E40\u0E1A\u0E2D\u0E23\u0E4C\u0E01\u0E25\u0E48\u0E2D\u0E07", hint: "\u0E23\u0E39\u0E1B\u0E41\u0E1A\u0E1A: \u0E15\u0E31\u0E27\u0E2D\u0E31\u0E01\u0E29\u0E23\u0E41\u0E16\u0E27 + \u0E40\u0E25\u0E02\u0E0A\u0E48\u0E2D\u0E07 \u0E40\u0E0A\u0E48\u0E19 A01, B03" }, /* @__PURE__ */ React.createElement("input", { className: "cf-boxnumber-field", style: { ...inputStyle, ...(boxNumberError ? { border: `1.5px solid ${C.coral}` } : {}) }, value: f.boxNumber, disabled: !isNew, onChange: (e) => { set("boxNumber", e.target.value.toUpperCase().replace(/[^A-Z0-9]/g, "")); setBoxNumberError(""); }, placeholder: "\u0E40\u0E0A\u0E48\u0E19 A01" }), boxNumberError && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11.5, color: C.coral, marginTop: 4, fontWeight: 600 } }, boxNumberError)), /* @__PURE__ */ React.createElement(Field, { label: "\u0E40\u0E1E\u0E28" }, /* @__PURE__ */ React.createElement("select", { style: inputStyle, value: f.sex, onChange: (e) => set("sex", e.target.value) }, /* @__PURE__ */ React.createElement("option", { value: "male" }, "\u0E15\u0E31\u0E27\u0E1C\u0E39\u0E49"), /* @__PURE__ */ React.createElement("option", { value: "female" }, "\u0E15\u0E31\u0E27\u0E40\u0E21\u0E35\u0E22"))), /* @__PURE__ */ React.createElement("div", { style: { gridColumn: "1 / -1" } }, /* @__PURE__ */ React.createElement(Field, { label: "\u0E27\u0E31\u0E19\u0E25\u0E07\u0E1B\u0E39" }, /* @__PURE__ */ React.createElement("input", { type: "date", className: "cf-date-field", style: inputStyle, value: f.stockDate || "", onChange: (e) => set("stockDate", e.target.value) }))), /* @__PURE__ */ React.createElement(Field, { label: "\u0E19\u0E49\u0E33\u0E2B\u0E19\u0E31\u0E01\u0E1B\u0E31\u0E08\u0E08\u0E38\u0E1A\u0E31\u0E19 (\u0E01\u0E23\u0E31\u0E21)" }, /* @__PURE__ */ React.createElement("input", { type: "number", style: inputStyle, value: f.currentWeight, onChange: (e) => set("currentWeight", e.target.value) })), /* @__PURE__ */ React.createElement(Field, { label: "\u0E19\u0E49\u0E33\u0E2B\u0E19\u0E31\u0E01\u0E40\u0E1B\u0E49\u0E32\u0E2B\u0E21\u0E32\u0E22 (\u0E01\u0E23\u0E31\u0E21)" }, /* @__PURE__ */ React.createElement("input", { type: "number", style: inputStyle, value: f.targetWeight, onChange: (e) => set("targetWeight", e.target.value) })), /* @__PURE__ */ React.createElement(Field, { label: "\u0E40\u0E1B\u0E49\u0E32\u0E2B\u0E21\u0E32\u0E22\u0E01\u0E25\u0E48\u0E2D\u0E07\u0E19\u0E35\u0E49" }, /* @__PURE__ */ React.createElement("select", { style: inputStyle, value: f.goal || "", onChange: (e) => set("goal", e.target.value) }, /* @__PURE__ */ React.createElement("option", { value: "" }, "\u0E44\u0E21\u0E48\u0E23\u0E30\u0E1A\u0E38"), /* @__PURE__ */ React.createElement("option", { value: "fatten" }, "\u0E02\u0E38\u0E19\u0E43\u0E2B\u0E49\u0E42\u0E15"), /* @__PURE__ */ React.createElement("option", { value: "eggs" }, "\u0E23\u0E2D\u0E44\u0E02\u0E48"), /* @__PURE__ */ React.createElement("option", { value: "molt" }, "\u0E23\u0E2D\u0E25\u0E2D\u0E01\u0E04\u0E23\u0E32\u0E1A"), /* @__PURE__ */ React.createElement("option", { value: "quick_sale" }, "\u0E02\u0E32\u0E22\u0E14\u0E48\u0E27\u0E19"), /* @__PURE__ */ React.createElement("option", { value: "broodstock" }, "\u0E1E\u0E48\u0E2D\u0E1E\u0E31\u0E19\u0E18\u0E38\u0E4C"))), f.sex === "female" && /* @__PURE__ */ React.createElement(Field, { label: "\u0E44\u0E02\u0E48 (%)" }, /* @__PURE__ */ React.createElement("input", { type: "number", min: "0", max: "100", style: inputStyle, value: f.eggPercent, onChange: (e) => set("eggPercent", e.target.value) })), /* @__PURE__ */ React.createElement(Field, { label: "\u0E1B\u0E23\u0E34\u0E21\u0E32\u0E13\u0E2D\u0E32\u0E2B\u0E32\u0E23/\u0E27\u0E31\u0E19 (\u0E01\u0E23\u0E31\u0E21)" }, /* @__PURE__ */ React.createElement("input", { type: "number", style: inputStyle, value: f.feedPerDay, onChange: (e) => set("feedPerDay", e.target.value) })), /* @__PURE__ */ React.createElement(Field, { label: "\u0E15\u0E49\u0E19\u0E17\u0E38\u0E19\u0E17\u0E35\u0E48\u0E23\u0E31\u0E1A\u0E21\u0E32 (\u0E1A\u0E32\u0E17/\u0E15\u0E31\u0E27)" }, /* @__PURE__ */ React.createElement("input", { type: "number", style: inputStyle, value: f.costPerCrab, onChange: (e) => set("costPerCrab", e.target.value) }))), econSection, !restock && !isNew && /* @__PURE__ */ React.createElement(MoltHistorySection, { f, settings, onAddMolt: addMoltEntry }), /* @__PURE__ */ React.createElement(Field, { label: "\u0E2B\u0E21\u0E32\u0E22\u0E40\u0E2B\u0E15\u0E38" }, /* @__PURE__ */ React.createElement("textarea", { style: { ...inputStyle, minHeight: 60, resize: "vertical" }, value: f.notes, onChange: (e) => set("notes", e.target.value) })), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", marginTop: 18 } }, /* @__PURE__ */ React.createElement("div", null, !isNew && onDelete && /* @__PURE__ */ React.createElement(Btn, { tone: "danger", onClick: async () => {
