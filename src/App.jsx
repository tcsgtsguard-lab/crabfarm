...
function App() {
  ...
  const financeByCategory = useMemo(() => {
    const base = () => ({ weightKg: 0, feedCostAccrued: 0, costBasis: 0, revenueNow: 0, revenueForecast: 0, profitNow: 0, profitForecast: 0, count: 0 });
