...
export default async function handler(req, res) {
  ...
  if (!apiKey) {
    res.status(500).json({
      error: "\u0E22\u0E31\u0E07\u0E44\u0E21\u0E48\u0E44\u0E14\u0E49\u0E15\u0E31\u0E49\u0E07\u0E04\u0E48\u0E32 GEMINI_API_KEY \u0E1A\u0E19 Vercel \u2014 \u0E2A\u0E21\u0E31\u0E04\u0E23 API key \u0E1F\u0E23\u0E35\u0E44\u0E14\u0E49\u0E17\u0E35\u0E48 https://aistudio.google.com/apikey \u0E41\u0E25\u0E49\u0E27\u0E44\u0E1B\u0E15\u0E31\u0E49\u0E07\u0E04\u0E48\u0E32\u0E17\u0E35\u0E48 Project Settings > Environment Variables \u0E1A\u0E19 Vercel \u0E08\u0E32\u0E01\u0E19\u0E31\u0E49\u0E19 deploy \u0E43\u0E2B\u0E21\u0E48"
    });
    return;
  }
